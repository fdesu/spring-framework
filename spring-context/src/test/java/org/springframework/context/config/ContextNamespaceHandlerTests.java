...
public class ContextNamespaceHandlerTests {
	...
	public void shouldFailWhenPlaceholderDeclaredButNotInitialised() {
		new ClassPathXmlApplicationContext("contextNamespaceHandlerTests-placeholder-location.xml", getClass());
	}
